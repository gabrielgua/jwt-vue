...
<template>
    <div class="container my-5">
        <h1>JWT Authentication example with <a target="_blank" href="https://vuejs.org"><i>Vue.js </i></a></h1>
        <hr class="border-secondary rounded">
        <small class="text-secondary">

            <p>This personal project is a single-page application (SPA) developed using Vue 3 and TypeScript. The main objectives are to enhance my proficiency with Vue 3, implement efficient state management using Pinia, and handle routing with Vue Router. Additionally, the project leverages JWT tokens for secure authentication, Spring Boot for building the backend API, and Bootstrap 5 for a responsive and modern frontend design.</p>
